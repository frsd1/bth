...
$(document).ready(function(){
  ...
  var t1 = document.getElementById('b1'),
   ...
   t00 = document.getElementById('b00');
 
    
  t00.swap = t1.swap = t2.swap = t3.swap = t4.swap = t5.swap = t6.swap = t7.swap = t8.swap = 1;

  t00.onclick = function() { this.className = (this.swap++ % 2) ? 'propellorHead saltomortal' : 'propellorHead'; };  
